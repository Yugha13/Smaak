...
export default function MenuCard({foodName, price}:{foodName: String, price: any}) {
  ...
  return (
    <Card className="bg-slate-900 rounded-xl p-0 m-0 transition ease-in-out delay-100 hover:-translate-y-1 hover:scale-110 hover:bg-slate-800 duration-300 w-[350px] h-fit">
    <CardHeader className="p-0 m-0">
      <img className="object-cover h-50 w-[100%] rounded-md" src={imgUrl}/>
    </CardHeader>
